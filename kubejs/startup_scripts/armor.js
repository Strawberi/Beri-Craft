...
onEvent('item.registry', event => {
    for (let [mat, d, b, e, t, k] of armors){
        event.create(mat + "_helmet").displayName(mat[0].toUpperCase() + " Helmet").type("helmet").tier(mat)
        event.create(mat + "_chestplate").displayName(mat[0].toUpperCase() + " Chestplate").type("chestplate").tier(mat)
        event.create(mat + "_leggings").displayName(mat[0].toUpperCase() + " Leggings").type("leggings").tier(mat)
        event.create(mat + "_boots").displayName(mat[0].toUpperCase() + " Boots").type("boots").tier(mat)
    }
})
